...
Here is the complete **README.md** file. I have preserved your exact questions and structure, adding a `<details>` tag with a clear explanation or code example for every single item.
